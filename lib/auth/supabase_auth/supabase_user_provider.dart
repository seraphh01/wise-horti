...
class WiseHortiSupabaseUser extends BaseAuthUser {
  WiseHortiSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> wiseHortiSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = WiseHortiSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
